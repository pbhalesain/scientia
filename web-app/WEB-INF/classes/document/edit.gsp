                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="documentMaster"><g:message code="document.documentMaster.label" default="Document Master" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: documentInstance, field: 'documentMaster', 'errors')}">
                                    <g:select name="documentMaster" from="${org.oplm.core.model.business.DocumentMaster.list()}" multiple="yes" optionKey="id" size="5" value="${documentInstance?.documentMaster}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="products"><g:message code="document.products.label" default="Products" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: documentInstance, field: 'products', 'errors')}">
                                    <g:select name="products" from="${org.oplm.core.model.business.ProductDocument.list()}" multiple="yes" optionKey="id" size="5" value="${documentInstance?.products}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="usesDocuments"><g:message code="document.usesDocuments.label" default="Uses Documents" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: documentInstance, field: 'usesDocuments', 'errors')}">
                                    <g:select name="usesDocuments" from="${org.oplm.core.model.business.DocumentStructure.list()}" multiple="yes" optionKey="id" size="5" value="${documentInstance?.usesDocuments}" />
                                </td>
                            </tr>
