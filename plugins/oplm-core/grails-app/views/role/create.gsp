                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="teamRole"><g:message code="role.teamRole.label" default="Team Role" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: roleInstance, field: 'teamRole', 'errors')}">
                                    <g:select name="teamRole.id" from="${org.oplm.core.model.admin.TeamRole.list()}" optionKey="id" value="${roleInstance?.teamRole?.id}"  />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="userRole"><g:message code="role.userRole.label" default="User Role" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: roleInstance, field: 'userRole', 'errors')}">
                                    <g:select name="userRole.id" from="${org.oplm.core.model.admin.UserRole.list()}" optionKey="id" value="${roleInstance?.userRole?.id}"  />
                                </td>
                            </tr>
